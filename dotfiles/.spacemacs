...
before packages are loaded."
  ...
  ; transient state
  (setq dotspacemacs-enable-paste-transient-state 1)
  ; remaps
  ...
  ;; latex save when compile autobuild
  ...
  (with-eval-after-load 'org
    ...
    (setq org-agenda-start-on-weekday nil)
                                        ; org latex export to handle references
    (setq org-latex-pdf-process 
          "latexmk -pdflatex='lualatex -shell-escape -interaction nonstopmode' -pdf -f  %f")
    (setq org-agenda-files
          '(
            "/home/nik/uoa/msc-thesis/implementation/experiments/plannning/msc.org"
            "/home/nik/work/iit/work.org"
            "/home/nik/work/iit/phd/phd.org"
            "/home/nik/life.org"
            ))
    (setq org-agenda-skip-archived-trees t)
    (setq org-agenda-skip-scheduled-if-done t)
    ;; capture
    (setq org-default-notes-file "/home/nik/org/capture.org")
    ;; refiling
  ...
  (setq mu4e-account-alist
        '(("gmail"
           ...
           (user-mail-address "pittarasnikif@gmail.com")
           (smtpmail-default-smtp-server "smtp.gmail.com")
           (smtpmail-smtp-server "smtp.gmail.com")
           ;; (smtpmail-smtp-service 587)
           (user-full-name "Nikiforos Pittaras")
           )
          ("di"
           (mu4e-sent-messages-behavior sent)
           (mu4e-sent-folder "/di/Sent Items")
           (mu4e-drafts-folder "/di/Drafts")
           (user-mail-address "npittaras@di.uoa.gr")
           (smtpmail-default-smtp-server "smtp.uoa.gr")
           (smtpmail-smtp-server "smtp.uoa.gr")
           ;; (smtpmail-smtp-service 587)
           (user-full-name "Nikiforos Pittaras"))
          ("iit"
           (mu4e-sent-messages-behavior sent)
           ...
           (smtpmail-default-smtp-server "mail.iit.demokritos.gr")
           (smtpmail-smtp-server "mail.iit.demokritos.gr")
           (user-mail-address "pittarasnikif@iit.demokritos.gr")
           ;; (smtpmail-smtp-service 587)
           (user-full-name "Nikiforos Pittaras"))
          ))
  ...
  (defvar my-mu4e-account-alist
    '(("gmail"
       ...
       (user-mail-address "pittarasnikif@gmail.com")
       (smtpmail-default-smtp-server "smtp.gmail.com")
       (smtpmail-smtp-user "pittarasnikif")
       (smtpmail-smtp-server "smtp.gmail.com")
       ;; (smtpmail-smtp-service 587)
       (user-full-name "Nikiforos Pittaras")
       )
  ...
  ; list of addresses to exclude from replying to
  (setq mu4e-user-mail-address-list '("pittarasnikif@gmail.com" "pittarsanikif@iit.demokritos.gr" "npittaras@di.uoa.gr"))
